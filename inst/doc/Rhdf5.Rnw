...
Objects can be written to the HDF5 file. Attributes attached to an object are written as well, if \code{write.attributes=FALSE} is not given as argument to \code{h5write}.
...
h5ls("myhdf5file.h5", objecttype="H5O_TYPE_DATASET")
@ 
