...
defined in the package \Rpkg{bit64}. Make sure that you have installed
\Rpkg{bit64}. \warning{The datatype \Rclass{integer64} is not part of base \R{}, but defined
in an external package. This can produce unexpected behaviour when
working with the data.} When choosing this option the package \Rpkg{bit64}
will be loaded.
