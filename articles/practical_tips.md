...
`index` argument with this set of columns takes 0.067 seconds. This poor
...
`split_and_gather()` using 1, 2, and 4 cores.
    ...
    ## 2 split/gather - 1 core   26.5   26.5
    ## 3 split/gather - 2 cores  13.6   13.6
    ## 4 split/gather - 4 cores  10.4   10.5
...
## Session info
    ...
    ## [4] rhdf5_2.57.7        BiocStyle_2.41.0   
    ## 
