...
`split_and_gather()` using 1, 2, and 4 cores.
    ...
    ##   <bch:expr>             <dbl>  <dbl>
    ## 1 simple writer           30.7   30.7
    ## 2 split/gather - 1 core   30.8   30.9
    ## 3 split/gather - 2 cores  15.8   15.9
    ## 4 split/gather - 4 cores  11.7   11.9
...
## Session info
    ...
    ## [4] rhdf5_2.57.10       BiocStyle_2.41.0   
    ## 
