...
`index` argument with this set of columns takes 0.095 seconds. This poor
...
`split_and_gather()` using 1, 2, and 4 cores.
    ...
    ##   <bch:expr>             <dbl>  <dbl>
    ## 1 simple writer           29.5   29.5
    ## 2 split/gather - 1 core   29.8   29.8
    ## 3 split/gather - 2 cores  15.4   15.5
