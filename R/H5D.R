...
#' the HDF5 C function \code{H5Dchunk_iter} and requires that the dataset
...
#' @export
H5Dchunk_iter <- function(h5dataset) {
  h5checktype(h5dataset, "dataset")
  .Call("_H5Dchunk_iter", h5dataset@ID, PACKAGE = "rhdf5")
}
