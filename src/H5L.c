 ...
 * *target_obj_name, hid_t link_loc_id, const char *link_name, hid_t lcpl_id,
 * hid_t lapl_id ) */
SEXP _H5Lcreate_external(SEXP _target_file_name, SEXP _target_obj_name,
                         SEXP _link_loc_id, SEXP _link_name) {
  ...
  herr_t herr =
      H5Lcreate_external(target_file_name, target_obj_name, link_loc_id,
...
/* herr_t H5Lget_info2( hid_t link_loc_id, const char *link_name, H5L_info2_t
...
SEXP _H5Lget_info(SEXP _loc_id, SEXP _name) {
  ...
  herr_t herr = H5Lget_info2(loc_id, name, &link_buff, H5P_DEFAULT);
  SEXP Rval;
  if (herr < 0) {
    Rval = R_NilValue;
  } else {
...
/* herr_t H5Lmove( hid_t src_loc_id, const char *src_name, hid_t dest_loc_id,
 * const char *dest_name, hid_t lcpl_id, hid_t lapl_id ) */
SEXP _H5Lmove(SEXP _src_loc_id, SEXP _src_name, SEXP _dest_loc_id,
              SEXP _dest_name, SEXP _lcpl_id, SEXP _lapl_id) {
  ...
  herr_t herr =
      H5Lmove(src_loc_id, src_name, dest_loc_id, dest_name, lcpl_id, lapl_id);
  SEXP Rval = ScalarInteger(herr);
  return Rval;
}

/* herr_t H5Lcopy( hid_t src_loc_id, const char *src_name, hid_t dest_loc_id,
 * const char *dest_name, hid_t lcpl_id, hid_t lapl_id ) */
SEXP _H5Lcopy(SEXP _src_loc_id, SEXP _src_name, SEXP _dest_loc_id,
              SEXP _dest_name, SEXP _lcpl_id, SEXP _lapl_id) {
  ...
  herr_t herr =
      H5Lcopy(src_loc_id, src_name, dest_loc_id, dest_name, lcpl_id, lapl_id);
  SEXP Rval = ScalarInteger(herr);
  return Rval;
}
