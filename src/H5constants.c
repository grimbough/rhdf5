...
SEXP _H5constants( void ) {
  ...
  int const_H5F_LIBVER[7]       = {  H5F_LIBVER_EARLIEST,   H5F_LIBVER_LATEST,   H5F_LIBVER_V18 ,  H5F_LIBVER_V110,   H5F_LIBVER_V112,   H5F_LIBVER_V114 };
  const char *name_H5F_LIBVER[] = { "H5F_LIBVER_EARLIEST", "H5F_LIBVER_LATEST", "H5F_LIBVER_V18", "H5F_LIBVER_V110", "H5F_LIBVER_V112", "H5F_LIBVER_V114"};
