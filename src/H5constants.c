...
SEXP _H5constants( void ) {
  ...
  int const_H5F_LIBVER[7]       = {  H5F_LIBVER_EARLIEST,   H5F_LIBVER_LATEST,   H5F_LIBVER_V18 ,  H5F_LIBVER_V110,   H5F_LIBVER_V112,   H5F_LIBVER_V114,   H5F_LIBVER_V200 };
  const char *name_H5F_LIBVER[] = { "H5F_LIBVER_EARLIEST", "H5F_LIBVER_LATEST", "H5F_LIBVER_V18", "H5F_LIBVER_V110", "H5F_LIBVER_V112", "H5F_LIBVER_V114", "H5F_LIBVER_V200"};
  addVector_int(i++, Rval, groupnames, "H5F_LIBVER", 6, const_H5F_LIBVER, name_H5F_LIBVER);
  ...
  int const_H5I_TYPE[14]       = { H5I_FILE, H5I_GROUP, H5I_DATATYPE, H5I_DATASPACE, H5I_DATASET, H5I_ATTR, 
