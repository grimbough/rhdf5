...
/* /\* herr_t H5Pget_sizes(hid_t plist, size_t * sizeof_addr, size_t *
 * sizeof_size) *\/ */
...
SEXP _H5Pset_shared_mesg_index(SEXP _plist, SEXP _index_num,
                               SEXP _mesg_type_flags, SEXP _min_mesg_size) {
  hid_t plist = STRSXP_2_HID(_plist);
  ...
  herr_t herr = H5Pset_shared_mesg_index(plist, index_num, mesg_type_flags,
                                         min_mesg_size);
  SEXP Rval = ScalarInteger(herr);
  return Rval;
}

/* /\* herr_t H5Pget_shared_mesg_index(hid_t fcpl_id, unsigned index_num,
 * unsigned mesg_type_flags, unsigned min_mesg_size) *\/ */
SEXP _H5Pget_shared_mesg_index(SEXP _plist, SEXP _index_num) {
  hid_t plist = STRSXP_2_HID(_plist);
  unsigned index_num = INTEGER_VALUE(_index_num), mesg_type_flags,
           min_mesg_size;
  herr_t herr = H5Pget_shared_mesg_index(plist, index_num, &mesg_type_flags,
                                         &min_mesg_size);
  SEXP Rval;
  if (herr >= 0) {
 ...
 * unsigned min_btree) *\/ */
SEXP _H5Pset_shared_mesg_phase_change(SEXP _plist, SEXP _max_list,
                                      SEXP _min_btree) {
  hid_t plist = STRSXP_2_HID(_plist);
...
/* /\* herr_t H5Pget_shared_mesg_phase_change(hid_t fcpl_id, unsigned max_list,
 * unsigned min_btree) *\/ */
 ...
 * new_driver_info) */
/* SEXP _H5Pset_driver( SEXP _plist_id, SEXP _new_driver_id, SEXP
 * _new_driver_info ) { */
...
/*   herr_t herr = H5Pset_driver(hid_tplist_id, hid_tnew_driver_id, const void
 * *new_driver_info); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/* /\* /\\* herr_t H5Pset_fclose_degree(hid_t fapl_id, H5F_close_degree_t
 * fc_degree) *\\/ *\/ */
...
/* /\*   herr_t herr = H5Pset_fclose_degree(hid_tfapl_id,
 * H5F_close_degree_tfc_degree); *\/ */
/* /\*   SEXP Rval = ScalarInteger(herr); *\/ */
/* /\*   return Rval; *\/ */
/* } */

/* /\* herr_t H5Pget_fclose_degree(hid_t fapl_id, H5F_close_degree_t *
 * fc_degree) *\/ */
/* SEXP _H5Pget_fclose_degree( SEXP _fapl_id, SEXP _fc_degree ) { */
/*   hid_t fapl_id = INTEGER(_fapl_id)[0]; */
/*   TODO: H5F_close_degree_t * fc_degree = _fc_degree */
/*   herr_t herr = H5Pget_fclose_degree(hid_tfapl_id, H5F_close_degree_t
 * *fc_degree); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pset_fapl_core(hid_t fapl_id, size_t increment, hbool_t
 * backing_store) *\/ */
...
/*   herr_t herr = H5Pset_fapl_core(hid_tfapl_id, size_tincrement,
 * hbool_tbacking_store); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pget_fapl_core(hid_t fapl_id, size_t increment, hbool_t
 * backing_store) *\/ */
...
/*   size_t increment = INTEGER(_increment)[0]; */
/*   TODO: hbool_t backing_store = _backing_store */
/*   herr_t herr = H5Pget_fapl_core(hid_tfapl_id, size_tincrement,
 * hbool_tbacking_store); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
 ...
 * size_t page_size) *\/ */
/* SEXP _H5Pset_core_write_tracking( SEXP _fapl_id, SEXP _is_enabled, SEXP
 * _page_size ) { */
/*   hid_t fapl_id = INTEGER(_fapl_id)[0]; */
/*   TODO: hbool_t is_enabled = _is_enabled */
/*   size_t page_size = INTEGER(_page_size)[0]; */
/*   herr_t herr = H5Pset_core_write_tracking(hid_tfapl_id, hbool_tis_enabled,
 * size_tpage_size); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
 ...
 * size_t page_size) *\/ */
/* SEXP _H5Pget_core_write_tracking( SEXP _fapl_id, SEXP _is_enabled, SEXP
 * _page_size ) { */
/*   hid_t fapl_id = INTEGER(_fapl_id)[0]; */
/*   TODO: hbool_t is_enabled = _is_enabled */
/*   size_t page_size = INTEGER(_page_size)[0]; */
/*   herr_t herr = H5Pget_core_write_tracking(hid_tfapl_id, hbool_tis_enabled,
 * size_tpage_size); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pset_fapl_direct(hid_t fapl_id, size_t alignment, size_t
 * block_size, size_t cbuf_size) *\/ */
/* SEXP _H5Pset_fapl_direct( SEXP _fapl_id, SEXP _alignment, SEXP _block_size,
 * SEXP _cbuf_size ) { */
/*   hid_t fapl_id = INTEGER(_fapl_id)[0]; */
/*   size_t alignment = INTEGER(_alignment)[0]; */
/*   size_t block_size = INTEGER(_block_size)[0]; */
/*   size_t cbuf_size = INTEGER(_cbuf_size)[0]; */
/*   herr_t herr = H5Pset_fapl_direct(hid_tfapl_id, size_talignment,
 * size_tblock_size, size_tcbuf_size); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pget_fapl_direct(hid_t fapl_id, size_t alignment, size_t
 * block_size, size_t cbuf_size) *\/ */
/* SEXP _H5Pget_fapl_direct( SEXP _fapl_id, SEXP _alignment, SEXP _block_size,
 * SEXP _cbuf_size ) { */
/*   hid_t fapl_id = INTEGER(_fapl_id)[0]; */
/*   size_t alignment = INTEGER(_alignment)[0]; */
/*   size_t block_size = INTEGER(_block_size)[0]; */
/*   size_t cbuf_size = INTEGER(_cbuf_size)[0]; */
/*   herr_t herr = H5Pget_fapl_direct(hid_tfapl_id, size_talignment,
 * size_tblock_size, size_tcbuf_size); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pset_fapl_family(hid_t fapl_id, hsize_t memb_size, hid_t
 * memb_fapl_id) *\/ */
...
/*   herr_t herr = H5Pset_fapl_family(hid_tfapl_id, hsize_tmemb_size,
 * hid_tmemb_fapl_id); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pget_fapl_family(hid_t fapl_id, hsize_t * memb_size, hid_t *
 * memb_fapl_id) *\/ */
...
/*   herr_t herr = H5Pget_fapl_family(hid_tfapl_id, hsize_t *memb_size, hid_t
 * *memb_fapl_id); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/* /\* herr_t H5Pset_fapl_log(hid_t fapl_id, const char * logfile, unsigned long
 * long flags, size_t buf_size) *\/ */
/* SEXP _H5Pset_fapl_log( SEXP _fapl_id, SEXP _logfile, SEXP _flags, SEXP
 * _buf_size ) { */
/*   hid_t fapl_id = INTEGER(_fapl_id)[0]; */
...
/*   herr_t herr = H5Pset_fapl_log(hid_tfapl_id, const char *logfile, unsigned
 * long longflags, size_tbuf_size); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/*   TODO: MPI_Comm * comm = _comm */
/*   TODO: MPI_Info * info = _info */
/*   herr_t herr = H5Pget_fapl_mpio(hid_tfapl_id, MPI_Comm *comm, MPI_Info
 * *info); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pset_fapl_mpiposix(hid_t fapl_id, MPI_Comm comm, hbool_t
 * use_gpfs_hints) *\/ */
...
/*   herr_t herr = H5Pset_fapl_mpiposix(hid_tfapl_id, MPI_Commcomm,
 * hbool_tuse_gpfs_hints); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/*   TODO: MPI_Comm * comm = _comm */
/*   TODO: hbool_t * use_gpfs_hints = _use_gpfs_hints */
/*   herr_t herr = H5Pget_fapl_mpiposix(hid_tfapl_id, MPI_Comm *comm, hbool_t
 * *use_gpfs_hints); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
 ...
 * const hid_t * memb_fapl, const char * const * memb_name, const haddr_t *
 * memb_addr, hbool_t relax) *\/ */
/* SEXP _H5Pset_fapl_multi( SEXP _fapl_id, SEXP _memb_map, SEXP _memb_fapl, SEXP
 * _memb_name, SEXP _memb_addr, SEXP _relax ) { */
/*   hid_t fapl_id = INTEGER(_fapl_id)[0]; */
...
/*   herr_t herr = H5Pset_fapl_multi(hid_tfapl_id, const H5FD_mem_t *memb_map,
 * const hid_t *memb_fapl, const char * const *memb_name, const haddr_t
 * *memb_addr, hbool_trelax); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pget_fapl_multi(hid_t fapl_id, const H5FD_mem_t * memb_map,
 * const hid_t * memb_fapl, const char ** memb_name, const haddr_t * memb_addr,
 * hbool_t * relax) *\/ */
/* SEXP _H5Pget_fapl_multi( SEXP _fapl_id, SEXP _memb_map, SEXP _memb_fapl, SEXP
 * _memb_name, SEXP _memb_addr, SEXP _relax ) { */
/*   hid_t fapl_id = INTEGER(_fapl_id)[0]; */
/*   TODO: const H5FD_mem_t * memb_map = _memb_map */
/*   TODO: const hid_t * memb_fapl = _memb_fapl */
...
/*   TODO: const haddr_t * memb_addr = _memb_addr */
/*   TODO: hbool_t * relax = _relax */
/*   herr_t herr = H5Pget_fapl_multi(hid_tfapl_id, const H5FD_mem_t *memb_map,
 * const hid_t *memb_fapl, const char **memb_name, const haddr_t *memb_addr,
 * hbool_t *relax); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
...
/* /\* herr_t H5Pset_fapl_split(hid_t fapl_id, const char * meta_ext, hid_t
 * meta_plist_id, const char * raw_ext, hid_t raw_plist_id) *\/ */
/* SEXP _H5Pset_fapl_split( SEXP _fapl_id, SEXP _meta_ext, SEXP _meta_plist_id,
 * SEXP _raw_ext, SEXP _raw_plist_id ) { */
/*   hid_t fapl_id = INTEGER(_fapl_id)[0]; */
...
/*   herr_t herr = H5Pset_fapl_split(hid_tfapl_id, const char *meta_ext,
 * hid_tmeta_plist_id, const char *raw_ext, hid_traw_plist_id); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/*   herr_t herr = H5Pset_file_image(hid_tfapl_id, void *buf_ptr,
 * size_tbuf_len); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pget_file_image(hid_t fapl_id, void ** buf_ptr_ptr, size_t *
 * buf_len_ptr) *\/ */
...
/*   herr_t herr = H5Pget_file_image(hid_tfapl_id, void **buf_ptr_ptr, size_t
 * *buf_len_ptr); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/*   herr_t herr = H5Pset_file_image_callbacks(hid_tfapl_id,
 * H5_file_image_callbacks_t *callbacks_ptr); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/*   hid_t fapl_id = INTEGER(_fapl_id)[0]; */
/*   TODO: H5_file_image_callbacks_t * callbacks_ptr = _callbacks_ptr */
/*   herr_t herr = H5Pget_file_image_callbacks(hid_tfapl_id,
 * H5_file_image_callbacks_t *callbacks_ptr); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/* /\* herr_t H5Pset_alignment(hid_t plist, hsize_t threshold, hsize_t
 * alignment) *\/ */
...
/*   herr_t herr = H5Pset_alignment(hid_tplist, hsize_tthreshold,
 * hsize_talignment); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pget_alignment(hid_t plist, hsize_t *threshold, hsize_t
 * *alignment) *\/ */
...
/*   herr_t herr = H5Pget_alignment(hid_tplist, hsize_t*threshold,
 * hsize_t*alignment); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/* SEXP _H5Pset_cache( SEXP _plist_id, SEXP _mdc_nelmts, SEXP _rdcc_nslots, SEXP
 * _rdcc_nbytes, SEXP _rdcc_w0 ) { */
/*   hid_t plist_id = INTEGER(_plist_id)[0]; */
...
/*   herr_t herr = H5Pset_cache(hid_tplist_id, intmdc_nelmts, size_trdcc_nslots,
 * size_trdcc_nbytes, doublerdcc_w0); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pget_cache(hid_t plist_id, int *mdc_nelmts, size_t *rdcc_nelmts,
 * size_t *rdcc_nbytes, double *rdcc_w0) *\/ */
/* SEXP _H5Pget_cache( SEXP _plist_id, SEXP _*mdc_nelmts, SEXP _*rdcc_nelmts,
 * SEXP _*rdcc_nbytes, SEXP _*rdcc_w0 ) { */
/*   hid_t plist_id = INTEGER(_plist_id)[0]; */
...
/*   herr_t herr = H5Pget_cache(hid_tplist_id, int*mdc_nelmts,
...
/*   herr_t herr = H5Pget_elink_file_cache_size(hid_tfapl_id, unsigned
 * *efc_size); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pset_mdc_config(hid_t plist_id, H5AC_cache_config_t *
 * config_ptr) *\/ */
/* SEXP _H5Pset_mdc_config( SEXP _plist_id, SEXP _config_ptr ) { */
/*   hid_t plist_id = INTEGER(_plist_id)[0]; */
/*   TODO: H5AC_cache_config_t * config_ptr = _config_ptr */
/*   herr_t herr = H5Pset_mdc_config(hid_tplist_id, H5AC_cache_config_t
 * *config_ptr); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pget_mdc_config(hid_t plist_id, H5AC_cache_config_t *
 * config_ptr) *\/ */
/* SEXP _H5Pget_mdc_config( SEXP _plist_id, SEXP _config_ptr ) { */
/*   hid_t plist_id = INTEGER(_plist_id)[0]; */
/*   TODO: H5AC_cache_config_t * config_ptr = _config_ptr */
/*   herr_t herr = H5Pget_mdc_config(hid_tplist_id, H5AC_cache_config_t
 * *config_ptr); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/* /\* herr_t H5Pset_libver_bounds(hid_t fapl_id, H5F_libver_t libver_low,
...
/* /\* herr_t H5Pget_libver_bounds(hid_t fapl_id, H5F_libver_t * libver_low,
 * H5F_libver_t * libver_high) *\/ */
...
SEXP _H5Pset_fapl_ros3(SEXP _fapl_id, SEXP _authenticate, SEXP _aws_region,
                       SEXP _access_key_id, SEXP _secret_access_key) {
...
/* /\* herr_t H5Pset_link_creation_order(hid_t gcpl_id, unsigned
 * crt_order_flags) *\/ */
/* SEXP _H5Pset_link_creation_order( SEXP _gcpl_id, SEXP _crt_order_flags ) { */
/*   hid_t gcpl_id = INTEGER(_gcpl_id)[0]; */
/*   unsigned crt_order_flags = INTEGER(_crt_order_flags)[0]; */
/*   herr_t herr = H5Pset_link_creation_order(hid_tgcpl_id,
 * unsignedcrt_order_flags); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pget_link_creation_order(hid_t gcpl_id, unsigned
 * crt_order_flags) *\/ */
/* SEXP _H5Pget_link_creation_order( SEXP _gcpl_id, SEXP _crt_order_flags ) { */
/*   hid_t gcpl_id = INTEGER(_gcpl_id)[0]; */
/*   unsigned crt_order_flags = INTEGER(_crt_order_flags)[0]; */
/*   herr_t herr = H5Pget_link_creation_order(hid_tgcpl_id,
 * unsignedcrt_order_flags); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/* SEXP _H5Pset_est_link_info( SEXP _gcpl_id, SEXP _est_num_entries, SEXP
 * _est_name_len ) { */
/*   hid_t gcpl_id = INTEGER(_gcpl_id)[0]; */
/*   unsigned est_num_entries = INTEGER(_est_num_entries)[0]; */
/*   unsigned est_name_len = INTEGER(_est_name_len)[0]; */
/*   herr_t herr = H5Pset_est_link_info(hid_tgcpl_id, unsignedest_num_entries,
 * unsignedest_name_len); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pget_est_link_info(hid_t gcpl_id, unsigned est_num_entries,
 * unsigned est_name_len) *\/ */
/* SEXP _H5Pget_est_link_info( SEXP _gcpl_id, SEXP _est_num_entries, SEXP
 * _est_name_len ) { */
/*   hid_t gcpl_id = INTEGER(_gcpl_id)[0]; */
/*   unsigned est_num_entries = INTEGER(_est_num_entries)[0]; */
/*   unsigned est_name_len = INTEGER(_est_name_len)[0]; */
/*   herr_t herr = H5Pget_est_link_info(hid_tgcpl_id, unsignedest_num_entries,
 * unsignedest_name_len); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
 ...
 * unsigned min_dense) *\/ */
/* SEXP _H5Pset_link_phase_change( SEXP _gcpl_id, SEXP _max_compact, SEXP
 * _min_dense ) { */
/*   hid_t gcpl_id = INTEGER(_gcpl_id)[0]; */
/*   unsigned max_compact = INTEGER(_max_compact)[0]; */
/*   unsigned min_dense = INTEGER(_min_dense)[0]; */
/*   herr_t herr = H5Pset_link_phase_change(hid_tgcpl_id, unsignedmax_compact,
 * unsignedmin_dense); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pget_link_phase_change(hid_t gcpl_id, unsigned max_compact,
 * unsigned min_dense) *\/ */
/* SEXP _H5Pget_link_phase_change( SEXP _gcpl_id, SEXP _max_compact, SEXP
 * _min_dense ) { */
/*   hid_t gcpl_id = INTEGER(_gcpl_id)[0]; */
/*   unsigned max_compact = INTEGER(_max_compact)[0]; */
/*   unsigned min_dense = INTEGER(_min_dense)[0]; */
/*   herr_t herr = H5Pget_link_phase_change(hid_tgcpl_id, unsignedmax_compact,
 * unsignedmin_dense); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
 ...
 * crt_intermed_group) */
SEXP _H5Pset_create_intermediate_group(SEXP _lcpl_id,
                                       SEXP _crt_intermed_group) {
...
/* /\* herr_t H5Pset_elink_cb(hid_t lapl_id, H5L_elink_traverse_t func, void *
 * op_data) *\/ */
...
/*   herr_t herr = H5Pset_elink_cb(hid_tlapl_id, H5L_elink_traverse_tfunc, void
 * *op_data); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pget_elink_cb(hid_t lapl_id, H5L_elink_traverse_t * func, void
 * ** op_data) *\/ */
/* SEXP _H5Pget_elink_cb( SEXP _lapl_id, SEXP _func, SEXP _op_data ) { */
/*   hid_t lapl_id = INTEGER(_lapl_id)[0]; */
/*   TODO: H5L_elink_traverse_t * func = _func */
/*   TODO: void ** op_data = _op_data */
/*   herr_t herr = H5Pget_elink_cb(hid_tlapl_id, H5L_elink_traverse_t *func,
 * void **op_data); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/* /\* herr_t H5Pset_filter(hid_t plist_id, H5Z_filter_t filter_id, unsigned int
 * flags, size_t cd_nelmts, const unsigned int cd_values[]) *\/ */
/* SEXP _H5Pset_filter( SEXP _plist_id, SEXP _filter_id, SEXP _flags, SEXP
 * _cd_nelmts, SEXP _cd_values[] ) { */
/*   hid_t plist_id = INTEGER(_plist_id)[0]; */
...
/*   herr_t herr = H5Pset_filter(hid_tplist_id, H5Z_filter_tfilter_id, unsigned
 * intflags, size_tcd_nelmts, const unsigned intcd_values[]); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

SEXP _H5Pset_filter(SEXP _plist_id, SEXP _filter_id, SEXP _mandatory,
                    SEXP _cd_values) {
  hid_t plist_id = STRSXP_2_HID(_plist_id);
  H5Z_filter_t filter_id = (H5Z_filter_t)INTEGER(_filter_id)[0];
  unsigned int flags =
      (asLogical(_mandatory) == 0) ? H5Z_FLAG_OPTIONAL : H5Z_FLAG_MANDATORY;
  size_t cd_nelmts = (size_t)length(_cd_values);
  unsigned int *cd_values =
      (unsigned int *)R_alloc(sizeof(unsigned int), cd_nelmts);
  for (int i = 0; i < cd_nelmts; i++) {
    cd_values[i] = INTEGER(_cd_values)[i];
  }
...
/* /\* H5Z_filter_t H5Pget_filter1(hid_t plist_id, unsigned int idx, unsigned
 * int * flags, size_t * cd_nelmts, unsigned int * cd_values, size_t namelen,
 * char name[]) *\/ */
/* SEXP _H5Pget_filter1( SEXP _plist_id, SEXP _idx, SEXP _flags, SEXP
 * _cd_nelmts, SEXP _cd_values, SEXP _namelen, SEXP _name[] ) { */
/*   hid_t plist_id = INTEGER(_plist_id)[0]; */
...
/* H5Pget_filter1(hid_tplist_id, unsigned intidx, unsigned int *flags, size_t
 * *cd_nelmts, unsigned int *cd_values, size_tnamelen, charname[]); */
/*   SEXP Rval = R_NilValue; */
/*   return Rval; */
/* TODO: UNKOWN RETURN VALUE */
/* } */

/* H5Z_filter_t H5Pget_filter2(hid_t plist_id, unsigned idx, unsigned int *
 * flags, size_t * cd_nelmts, unsigned cd_values[], size_t namelen, char name[],
...
SEXP _H5Pget_filter(SEXP _plist_id, SEXP _idx) {
  ...
  H5Z_filter_t filt_id =
      H5Pget_filter2(plist_id, idx, &flags, &cd_nelmts, cd_values, namelen,
                     name, &filter_config);
...
/* /\* herr_t H5Pget_filter_by_id1(hid_t plist_id, H5Z_filter_t filter_id,
 * unsigned int * flags, size_t * cd_nelmts, unsigned int cd_values[], size_t
 * namelen, char name[]) *\/ */
/* SEXP _H5Pget_filter_by_id1( SEXP _plist_id, SEXP _filter_id, SEXP _flags,
 * SEXP _cd_nelmts, SEXP _cd_values[], SEXP _namelen, SEXP _name[] ) { */
/*   hid_t plist_id = INTEGER(_plist_id)[0]; */
/*   TODO: H5Z_filter_t filter_id = _filter_id */
/*   TODO: unsigned int * flags = _flags */
/*   TODO: size_t * cd_nelmts = _cd_nelmts */
...
/*   size_t namelen = INTEGER(_namelen)[0]; */
/*   TODO: char name[] = INTEGER(_name[])[0]; */
/*   herr_t herr = H5Pget_filter_by_id1(hid_tplist_id, H5Z_filter_tfilter_id,
 * unsigned int *flags, size_t *cd_nelmts, unsigned intcd_values[],
 * size_tnamelen, charname[]); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
 ...
 * unsigned int * flags, size_t * cd_nelmts, unsigned int cd_values[], size_t
 * namelen, char name[], unsigned int * filter_config) *\/ */
/* SEXP _H5Pget_filter_by_id2( SEXP _plist_id, SEXP _filter_id, SEXP _flags,
 * SEXP _cd_nelmts, SEXP _cd_values[], SEXP _namelen, SEXP _name[], SEXP
 * _filter_config ) { */
/*   hid_t plist_id = INTEGER(_plist_id)[0]; */
/*   TODO: H5Z_filter_t filter_id = _filter_id */
/*   TODO: unsigned int * flags = _flags */
...
/*   herr_t herr = H5Pget_filter_by_id2(hid_tplist_id, H5Z_filter_tfilter_id,
 * unsigned int *flags, size_t *cd_nelmts, unsigned intcd_values[],
 * size_tnamelen, charname[], unsigned int *filter_config); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pmodify_filter(hid_t plist_id, H5Z_filter_t filter_id, unsigned
 * int flags, size_t cd_nelmts, const unsigned int cd_values[]) *\/ */
/* SEXP _H5Pmodify_filter( SEXP _plist_id, SEXP _filter_id, SEXP _flags, SEXP
 * _cd_nelmts, SEXP _cd_values[] ) { */
/*   hid_t plist_id = INTEGER(_plist_id)[0]; */
/*   TODO: H5Z_filter_t filter_id = _filter_id */
/*   unsigned int flags = INTEGER(_flags)[0]; */
/*   size_t cd_nelmts = INTEGER(_cd_nelmts)[0]; */
/*   const unsigned int cd_values[] = INTEGER(_cd_values[])[0]; */
/*   herr_t herr = H5Pmodify_filter(hid_tplist_id, H5Z_filter_tfilter_id,
 * unsigned intflags, size_tcd_nelmts, const unsigned intcd_values[]); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
 ...
 * int scale_factor) *\/ */
/* SEXP _H5Pset_scaleoffset( SEXP _plist_id, SEXP _scale_type, SEXP
 * _scale_factor ) { */
/*   hid_t plist_id = INTEGER(_plist_id)[0]; */
/*   TODO: H5Z_SO_scale_type_t scale_type = _scale_type */
/*   int scale_factor = INTEGER(_scale_factor)[0]; */
/*   herr_t herr = H5Pset_scaleoffset(hid_tplist_id,
 * H5Z_SO_scale_type_tscale_type, intscale_factor); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/*   hsize_t size = INTEGER(_size)[0]; */
/*   herr_t herr = H5Pset_external(hid_tplist, const char*name, off_toffset,
 * hsize_tsize); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/* /\* herr_t H5Pget_external(hid_t plist, unsigned idx, size_t name_size, char
 * *name, off_t *offset, hsize_t *size) *\/ */
/* SEXP _H5Pget_external( SEXP _plist, SEXP _idx, SEXP _name_size, SEXP _*name,
 * SEXP _*offset, SEXP _*size ) { */
/*   hid_t plist = INTEGER(_plist)[0]; */
/*   unsigned idx = INTEGER(_idx)[0]; */
...
/*   herr_t herr = H5Pget_external(hid_tplist, unsignedidx, size_tname_size,
...
/* herr_t H5Pset_chunk_cache(hid_t dapl_id, size_t rdcc_nslots, size_t
 * rdcc_nbytes, double rdcc_w0) */
SEXP _H5Pset_chunk_cache(SEXP _dapl_id, SEXP _rdcc_nslots, SEXP _rdcc_nbytes,
                         SEXP _rdcc_w0) {
...
/* /\* herr_t H5Pget_chunk_cache(hid_t dapl_id, size_t * rdcc_nslots, size_t *
 * rdcc_nbytes, double * rdcc_w0) *\/ */
...
/* /\* herr_t H5Pset_filter_callback(hid_t plist, H5Z_filter_func_t func, void *
 * op_data) *\/ */
/* SEXP _H5Pset_filter_callback( SEXP _plist, SEXP _func, SEXP _op_data ) { */
/*   hid_t plist = INTEGER(_plist)[0]; */
/*   TODO: H5Z_filter_func_t func = _func */
/*   TODO: void * op_data = _op_data */
/*   herr_t herr = H5Pset_filter_callback(hid_tplist, H5Z_filter_func_tfunc,
 * void *op_data); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/* /\* ssize_t H5Pget_data_transform(hid_t plist_id, char expression, size_t
 * size) *\/ */
...
/*   size_t size = INTEGER(_size)[0]; */
/*   ssize_t s = H5Pget_data_transform(hid_tplist_id, charexpression,
 * size_tsize); */
/*   SEXP Rval = ScalarInteger(s); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pset_type_conv_cb(hid_t plist, H5T_conv_except_func_t func, void
 * * op_data) *\/ */
/* SEXP _H5Pset_type_conv_cb( SEXP _plist, SEXP _func, SEXP _op_data ) { */
/*   hid_t plist = INTEGER(_plist)[0]; */
/*   TODO: H5T_conv_except_func_t func = _func */
/*   TODO: void * op_data = _op_data */
/*   herr_t herr = H5Pset_type_conv_cb(hid_tplist, H5T_conv_except_func_tfunc,
 * void *op_data); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pget_type_conv_cb(hid_t plist, H5T_conv_except_func_t * func,
 * void ** op_data) *\/ */
/* SEXP _H5Pget_type_conv_cb( SEXP _plist, SEXP _func, SEXP _op_data ) { */
/*   hid_t plist = INTEGER(_plist)[0]; */
/*   TODO: H5T_conv_except_func_t * func = _func */
/*   TODO: void ** op_data = _op_data */
/*   herr_t herr = H5Pget_type_conv_cb(hid_tplist, H5T_conv_except_func_t *func,
 * void **op_data); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/* /\* herr_t H5Pset_btree_ratios(hid_t plist, double left, double middle,
 * double right) *\/ */
...
/*   herr_t herr = H5Pset_btree_ratios(hid_tplist, doubleleft, doublemiddle,
 * doubleright); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pget_btree_ratios(hid_t plist, double left, double middle,
 * double right) *\/ */
...
/*   double middle = REAL(_middle)[0]; */
/*   double right = REAL(_right)[0]; */
/*   herr_t herr = H5Pget_btree_ratios(hid_tplist, doubleleft, doublemiddle,
 * doubleright); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/* SEXP _H5Pset_vlen_mem_manager( SEXP _plist, SEXP _alloc, SEXP _alloc_info,
 * SEXP _free, SEXP _free_info ) { */
/*   hid_t plist = INTEGER(_plist)[0]; */
...
/*   herr_t herr = H5Pset_vlen_mem_manager(hid_tplist, H5MM_allocate_talloc,
 * voidalloc_info, H5MM_free_tfree, voidfree_info); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
 ...
 * alloc_info, H5MM_free_t free, void free_info) *\/ */
/* SEXP _H5Pget_vlen_mem_manager( SEXP _plist, SEXP _alloc, SEXP _alloc_info,
 * SEXP _free, SEXP _free_info ) { */
/*   hid_t plist = INTEGER(_plist)[0]; */
/*   TODO: H5MM_allocate_t alloc = _alloc */
/*   TODO: void alloc_info = _alloc_info */
/*   TODO: H5MM_free_t free = _free */
/*   TODO: void free_info = _free_info */
/*   herr_t herr = H5Pget_vlen_mem_manager(hid_tplist, H5MM_allocate_talloc,
 * voidalloc_info, H5MM_free_tfree, voidfree_info); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/*   herr_t herr = H5Pset_dxpl_mpio_chunk_opt(hid_tdxpl_id,
 * H5FD_mpio_chunk_opt_topt_mode); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/*   herr_t herr = H5Pset_dxpl_mpio_chunk_opt_num(hid_tdxpl_id,
 * unsignednum_chunk_per_proc); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/* SEXP _H5Pset_dxpl_mpio_chunk_opt_ratio( SEXP _dxpl_id, SEXP
 * _percent_proc_per_chunk ) { */
/*   hid_t dxpl_id = INTEGER(_dxpl_id)[0]; */
/*   unsigned percent_proc_per_chunk = INTEGER(_percent_proc_per_chunk)[0]; */
/*   herr_t herr = H5Pset_dxpl_mpio_chunk_opt_ratio(hid_tdxpl_id,
 * unsignedpercent_proc_per_chunk); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/*   herr_t herr = H5Pset_dxpl_mpio_collective_opt(hid_tdxpl_id,
 * H5FD_mpio_collective_opt_topt_mode); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/* SEXP _H5Pget_mpio_actual_chunk_opt_mode( SEXP _dxpl_id, SEXP
 * _actual_chunk_opt_mode ) { */
/*   hid_t dxpl_id = INTEGER(_dxpl_id)[0]; */
/*   TODO: H5D_mpio_actual_chunk_opt_mode_t * actual_chunk_opt_mode =
 * _actual_chunk_opt_mode */
/*   herr_t herr = H5Pget_mpio_actual_chunk_opt_mode(hid_tdxpl_id,
 * H5D_mpio_actual_chunk_opt_mode_t *actual_chunk_opt_mode); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/*   herr_t herr = H5Pget_mpio_actual_io_mode(hid_tdxpl_id,
 * H5D_mpio_actual_io_mode_t *actual_io_mode); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pget_mpio_no_collective_cause(hid_t dxpl_id, uint32_t *
 * local_no_collective_cause, uint32_t * global_no_collective_cause) *\/ */
/* SEXP _H5Pget_mpio_no_collective_cause( SEXP _dxpl_id, SEXP
 * _local_no_collective_cause, SEXP _global_no_collective_cause ) { */
/*   hid_t dxpl_id = INTEGER(_dxpl_id)[0]; */
 ...
 */
/*   herr_t herr = H5Pget_mpio_no_collective_cause(hid_tdxpl_id, uint32_t
 * *local_no_collective_cause, uint32_t *global_no_collective_cause); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/* /\* herr_t H5Pset_create_intermediate_group(hid_t lcpl_id, unsigned
 * crt_intermed_group) *\/ */
/* SEXP _H5Pset_create_intermediate_group( SEXP _lcpl_id, SEXP
 * _crt_intermed_group ) { */
/*   hid_t lcpl_id = INTEGER(_lcpl_id)[0]; */
/*   unsigned crt_intermed_group = INTEGER(_crt_intermed_group)[0]; */
/*   herr_t herr = H5Pset_create_intermediate_group(hid_tlcpl_id,
 * unsignedcrt_intermed_group); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/* /\* herr_t H5Pget_create_intermediate_group(hid_t lcpl_id, unsigned *
 * crt_intermed_group) *\/ */
/* SEXP _H5Pget_create_intermediate_group( SEXP _lcpl_id, SEXP
 * _crt_intermed_group ) { */
/*   hid_t lcpl_id = INTEGER(_lcpl_id)[0]; */
/*   TODO: unsigned * crt_intermed_group = _crt_intermed_group */
/*   herr_t herr = H5Pget_create_intermediate_group(hid_tlcpl_id, unsigned
 * *crt_intermed_group); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
 ...
 * unsigned min_dense) *\/ */
/* SEXP _H5Pset_attr_phase_change( SEXP _ocpl_id, SEXP _max_compact, SEXP
 * _min_dense ) { */
/*   hid_t ocpl_id = INTEGER(_ocpl_id)[0]; */
/*   unsigned max_compact = INTEGER(_max_compact)[0]; */
/*   unsigned min_dense = INTEGER(_min_dense)[0]; */
/*   herr_t herr = H5Pset_attr_phase_change(hid_tocpl_id, unsignedmax_compact,
 * unsignedmin_dense); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pget_attr_phase_change(hid_t ocpl_id, unsigned max_compact,
 * unsigned min_dense) *\/ */
/* SEXP _H5Pget_attr_phase_change( SEXP _ocpl_id, SEXP _max_compact, SEXP
 * _min_dense ) { */
/*   hid_t ocpl_id = INTEGER(_ocpl_id)[0]; */
/*   unsigned max_compact = INTEGER(_max_compact)[0]; */
/*   unsigned min_dense = INTEGER(_min_dense)[0]; */
/*   herr_t herr = H5Pget_attr_phase_change(hid_tocpl_id, unsignedmax_compact,
 * unsignedmin_dense); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pset_attr_creation_order(hid_t ocpl_id, unsigned
 * crt_order_flags) *\/ */
/* SEXP _H5Pset_attr_creation_order( SEXP _ocpl_id, SEXP _crt_order_flags ) { */
/*   hid_t ocpl_id = INTEGER(_ocpl_id)[0]; */
/*   unsigned crt_order_flags = INTEGER(_crt_order_flags)[0]; */
/*   herr_t herr = H5Pset_attr_creation_order(hid_tocpl_id,
 * unsignedcrt_order_flags); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pget_attr_creation_order(hid_t ocpl_id, unsigned
 * crt_order_flags) *\/ */
/* SEXP _H5Pget_attr_creation_order( SEXP _ocpl_id, SEXP _crt_order_flags ) { */
/*   hid_t ocpl_id = INTEGER(_ocpl_id)[0]; */
/*   unsigned crt_order_flags = INTEGER(_crt_order_flags)[0]; */
/*   herr_t herr = H5Pget_attr_creation_order(hid_tocpl_id,
 * unsignedcrt_order_flags); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/*   herr_t herr = H5Pget_copy_object(hid_tocp_plist_id, unsigned
 * *copy_options); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/*   herr_t herr = H5Padd_merge_committed_dtype_path(hid_tocpypl_id, char
 * *path); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/* /\* herr_t H5Pset_mcdt_search_cb(hid_t ocpypl_id, H5O_mcdt_search_cb_t func,
 * void * op_data) *\/ */
...
/*   TODO: void * op_data = _op_data */
/*   herr_t herr = H5Pset_mcdt_search_cb(hid_tocpypl_id,
 * H5O_mcdt_search_cb_tfunc, void *op_data); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pget_mcdt_search_cb(hid_t ocpypl_id, H5O_mcdt_search_cb_t *
 * func, void ** op_data) *\/ */
...
/*   TODO: H5O_mcdt_search_cb_t * func = _func */
/*   TODO: void ** op_data = _op_data */
/*   herr_t herr = H5Pget_mcdt_search_cb(hid_tocpypl_id, H5O_mcdt_search_cb_t
 * *func, void **op_data); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */
...
/* /\* hid_t H5Pcreate_class(hid_t parent_class, const char * name,
...
/* SEXP _H5Pcreate_class( SEXP _parent_class, SEXP _name, SEXP _create, SEXP
 * _create_data, SEXP _copy, SEXP _copy_data, SEXP _close, SEXP _close_data ) {
 */
...
/*   hid_t hid = H5Pcreate_class(hid_tparent_class, const char *name,
 * H5P_cls_create_func_tcreate, void *create_data, H5P_cls_copy_func_tcopy, void
 * *copy_data, H5P_cls_close_func_tclose, void *close_data); */
/*   addHandle(hid); */
/*   SEXP Rval = ScalarInteger(hid); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pregister1(hid_t class, const char * name, size_t size, void *
 * default, H5P_prp_create_func_t create, H5P_prp_set_func_t set,
 * H5P_prp_get_func_t get, H5P_prp_delete_func_t delete, H5P_prp_copy_func_t
 * copy, H5P_prp_close_func_t close) *\/ */
/* SEXP _H5Pregister1( SEXP _class, SEXP _name, SEXP _size, SEXP _default, SEXP
 * _create, SEXP _set, SEXP _get, SEXP _delete, SEXP _copy, SEXP _close ) { */
...
/*   herr_t herr = H5Pregister1(hid_tclass, const char *name, size_tsize, void
 * *default, H5P_prp_create_func_tcreate, H5P_prp_set_func_tset,
 * H5P_prp_get_func_tget, H5P_prp_delete_func_tdelete, H5P_prp_copy_func_tcopy,
 * H5P_prp_close_func_tclose); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pregister2(hid_t class, const char * name, size_t size, void *
 * default, H5P_prp_create_func_t create, H5P_prp_set_func_t set,
 * H5P_prp_get_func_t get, H5P_prp_delete_func_t delete, H5P_prp_copy_func_t
 * copy, H5P_prp_compare_func_t compare, H5P_prp_close_func_t close) *\/ */
/* SEXP _H5Pregister2( SEXP _class, SEXP _name, SEXP _size, SEXP _default, SEXP
 * _create, SEXP _set, SEXP _get, SEXP _delete, SEXP _copy, SEXP _compare, SEXP
 * _close ) { */
/*   hid_t class = INTEGER(_class)[0]; */
/*   const char * name = CHAR(STRING_ELT(_name, 0)); */
/*   size_t size = INTEGER(_size)[0]; */
...
/*   TODO: H5P_prp_close_func_t close = _close */
/*   herr_t herr = H5Pregister2(hid_tclass, const char *name, size_tsize, void
 * *default, H5P_prp_create_func_tcreate, H5P_prp_set_func_tset,
 * H5P_prp_get_func_tget, H5P_prp_delete_func_tdelete, H5P_prp_copy_func_tcopy,
 * H5P_prp_compare_func_tcompare, H5P_prp_close_func_tclose); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pinsert1(hid_t plid, const char * name, size_t size, void *
 * value, H5P_prp_set_func_t set, H5P_prp_get_func_t get, H5P_prp_delete_func_t
 * delete, H5P_prp_copy_func_t copy, H5P_prp_close_func_t close) *\/ */
/* SEXP _H5Pinsert1( SEXP _plid, SEXP _name, SEXP _size, SEXP _value, SEXP _set,
 * SEXP _get, SEXP _delete, SEXP _copy, SEXP _close ) { */
...
/*   TODO: H5P_prp_copy_func_t copy = _copy */
/*   TODO: H5P_prp_close_func_t close = _close */
/*   herr_t herr = H5Pinsert1(hid_tplid, const char *name, size_tsize, void
 * *value, H5P_prp_set_func_tset, H5P_prp_get_func_tget,
 * H5P_prp_delete_func_tdelete, H5P_prp_copy_func_tcopy,
 * H5P_prp_close_func_tclose); */
/*   SEXP Rval = ScalarInteger(herr); */
/*   return Rval; */
/* } */

/* /\* herr_t H5Pinsert2(hid_t plid, const char * name, size_t size, void *
 * value, H5P_prp_set_func_t set, H5P_prp_get_func_t get, H5P_prp_delete_func_t
 * delete, H5P_prp_copy_func_t copy, H5P_prp_compare_func_t compare,
 * H5P_prp_close_func_t close) *\/ */
/* SEXP _H5Pinsert2( SEXP _plid, SEXP _name, SEXP _size, SEXP _value, SEXP _set,
 * SEXP _get, SEXP _delete, SEXP _copy, SEXP _compare, SEXP _close ) { */
/*   hid_t plid = INTEGER(_plid)[0]; */
/*   const char * name = CHAR(STRING_ELT(_name, 0)); */
/*   size_t size = INTEGER(_size)[0]; */
/*   TODO: void * value = _value */
...
/*   TODO: H5P_prp_compare_func_t compare = _compare */
/*   TODO: H5P_prp_close_func_t close = _close */
/*   herr_t herr = H5Pinsert2(hid_tplid, const char *name, size_tsize, void
 * *value, H5P_prp_set_func_tset, H5P_prp_get_func_tget,
 * H5P_prp_delete_func_tdelete, H5P_prp_copy_func_tcopy,
 * H5P_prp_compare_func_tcompare, H5P_prp_close_func_tclose); */
/*   SEXP Rval = ScalarInteger(herr); */
...
/* /\* int H5Piterate(hid_t id, int * idx, H5P_iterate_t iter_func, void *
 * iter_data) *\/ */
...
/*   int n = H5Piterate(hid_tid, int *idx, H5P_iterate_titer_func, void
 * *iter_data); */
/*   SEXP Rval = ScalarInteger(n); */
/*   return Rval; */
/* } */
