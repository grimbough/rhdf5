...
static R_CallMethodDef libraryRCalls[] = {
    ...
    {"_H5Sget_select_hyper_blocklist", (DL_FUNC)&_H5Sget_select_hyper_blocklist,
     4},
    ...
    {"_H5Pset_shared_mesg_phase_change",
     (DL_FUNC)&_H5Pset_shared_mesg_phase_change, 3},
    {"_H5Pget_shared_mesg_phase_change",
     (DL_FUNC)&_H5Pget_shared_mesg_phase_change, 1},
    ...
    /* {"_H5Pset_core_write_tracking", (DL_FUNC) &_H5Pset_core_write_tracking,
       3}, */
    /* {"_H5Pget_core_write_tracking", (DL_FUNC) &_H5Pget_core_write_tracking,
       3}, */
    ...
    /* {"_H5Pset_file_image_callbacks", (DL_FUNC) &_H5Pset_file_image_callbacks,
       2}, */
    /* {"_H5Pget_file_image_callbacks", (DL_FUNC) &_H5Pget_file_image_callbacks,
       2}, */
    ...
    /* {"_H5Pset_elink_file_cache_size", (DL_FUNC)
       &_H5Pset_elink_file_cache_size, 2}, */
    /* {"_H5Pget_elink_file_cache_size", (DL_FUNC)
       &_H5Pget_elink_file_cache_size, 2}, */
    ...
    /* {"_H5Pset_small_data_block_size", (DL_FUNC)
       &_H5Pset_small_data_block_size, 2}, */
    /* {"_H5Pget_small_data_block_size", (DL_FUNC)
       &_H5Pget_small_data_block_size, 2}, */
    ...
    /* {"_H5Pset_local_heap_size_hint", (DL_FUNC) &_H5Pset_local_heap_size_hint,
       2}, */
    /* {"_H5Pget_local_heap_size_hint", (DL_FUNC) &_H5Pget_local_heap_size_hint,
       2}, */
    /* {"_H5Pset_link_creation_order", (DL_FUNC) &_H5Pset_link_creation_order,
       2}, */
    /* {"_H5Pget_link_creation_order", (DL_FUNC) &_H5Pget_link_creation_order,
       2}, */
    ...
    {"_H5Pset_create_intermediate_group",
     (DL_FUNC)&_H5Pset_create_intermediate_group, 2},
    {"_H5Pget_create_intermediate_group",
     (DL_FUNC)&_H5Pget_create_intermediate_group, 1},
    ...
    /* {"_H5Pset_dxpl_mpio_chunk_opt", (DL_FUNC) &_H5Pset_dxpl_mpio_chunk_opt,
       2}, */
    /* {"_H5Pset_dxpl_mpio_chunk_opt_num", (DL_FUNC)
       &_H5Pset_dxpl_mpio_chunk_opt_num, 2}, */
    /* {"_H5Pset_dxpl_mpio_chunk_opt_ratio", (DL_FUNC)
       &_H5Pset_dxpl_mpio_chunk_opt_ratio, 2}, */
    /* {"_H5Pset_dxpl_mpio_collective_opt", (DL_FUNC)
       &_H5Pset_dxpl_mpio_collective_opt, 2}, */
    /* {"_H5Pget_dxpl_mpio", (DL_FUNC) &_H5Pget_dxpl_mpio, 2}, */
    /* {"_H5Pget_mpio_actual_chunk_opt_mode", (DL_FUNC)
       &_H5Pget_mpio_actual_chunk_opt_mode, 2}, */
    /* {"_H5Pget_mpio_actual_io_mode", (DL_FUNC) &_H5Pget_mpio_actual_io_mode,
       2}, */
    /* {"_H5Pget_mpio_no_collective_cause", (DL_FUNC)
       &_H5Pget_mpio_no_collective_cause, 3}, */
    /* {"_H5Pset_create_intermediate_group", (DL_FUNC)
       &_H5Pset_create_intermediate_group, 2}, */
    /* {"_H5Pget_create_intermediate_group", (DL_FUNC)
       &_H5Pget_create_intermediate_group, 2}, */
     ...
     */
    /* {"_H5Pset_attr_creation_order", (DL_FUNC) &_H5Pset_attr_creation_order,
       2}, */
    /* {"_H5Pget_attr_creation_order", (DL_FUNC) &_H5Pget_attr_creation_order,
       2}, */
    /* {"_H5Pset_copy_object", (DL_FUNC) &_H5Pset_copy_object, 2}, */
    /* {"_H5Pget_copy_object", (DL_FUNC) &_H5Pget_copy_object, 2}, */
    /* {"_H5Padd_merge_committed_dtype_path", (DL_FUNC)
       &_H5Padd_merge_committed_dtype_path, 2}, */
    /* {"_H5Pfree_merge_committed_dtype_paths", (DL_FUNC)
       &_H5Pfree_merge_committed_dtype_paths, 1}, */
