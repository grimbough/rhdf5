...
char *getDatatypeName(hid_t type) {
  ...
  if (H5Tcommitted(type) > 0) {
    ...
    case H5T_STRING:
      ...
      /*                 /\* Make a copy of type in memory in case when TYPE is
       * on disk, the size */
      /*                  * will be bigger than in memory.  This makes it easier
       * to compare */
      /*                  * types in memory. *\/ */
      ...
      /*                 /\* Check C variable-length string first. Are the two
       * types equal? *\/ */
      ...
      /*                 /\* If not equal to C variable-length string, check
       * Fortran type. *\/ */
      /*                 H5Tclose(str_type); */
    ...
    case H5T_REFERENCE:
      ...
      /*                 /\* The BNF document states that the type of reference
       * should be */
      /*                  * displayed after "H5T_REFERENCE". Therefore add the
       * missing */
      /*                  * reference type if the region command line option is
       * used. This */
      /*                  * reference type will not be displayed if the region
       * option is not used. *\/ */
      /*                 if(display_region) { */
    ...
    case H5T_VLEN:
      ...
      /*                 printf("H5T_VLEN %s ",
       * dump_header_format->vlenblockbegin); */
      /*                 super = H5Tget_super(type); */
      /*                 print_datatype(super,0); */
      /*                 H5Tclose(super); */
