...
###################################################
### code chunk number 3: createHDF5file
###################################################
library(rhdf5)
...
###################################################
### code chunk number 4: create groups
###################################################
...
###################################################
### code chunk number 5: writeMatrix
###################################################
...
###################################################
### code chunk number 6: accessorH5Fopen
###################################################
...
###################################################
### code chunk number 7: accessorDF
###################################################
h5f$df
h5f&'df'
...
###################################################
### code chunk number 8: accessorC1
###################################################
h5f$foo$foobaa$C
h5f$"/foo/foobaa/C"
...
###################################################
### code chunk number 9: accessorB1
###################################################
h5d = h5f&"/foo/B"
h5d[]
h5d[3,,]
...
###################################################
### code chunk number 10: accessorB2
###################################################
h5d[3,,] = 1:4
H5Fflush(h5f)
...
###################################################
### code chunk number 11: accessorB3 (eval = FALSE)
###################################################
## h5f$foo$B = 101:120
## h5f$"/foo/B" = 101:120
...
###################################################
### code chunk number 12: accessorClose1
###################################################
H5Dclose(h5d)
H5Fclose(h5f)
...
###################################################
### code chunk number 13: accessorClose2
###################################################
H5close()


###################################################
### code chunk number 14: writeMatrixSubsetting
###################################################
...
###################################################
### code chunk number 15: writeMatrixHyperslab
###################################################
...
###################################################
### code chunk number 19: h5dump (eval = FALSE)
###################################################
## system("h5dump myhdf5file.h5")


###################################################
### code chunk number 20: bit64integer1
###################################################
...
###################################################
### code chunk number 21: bit64integer2
###################################################
...
###################################################
### code chunk number 22: bit64integer3
###################################################
...
###################################################
### code chunk number 23: bit64integer4
###################################################
...
###################################################
### code chunk number 24: createfile
###################################################
library(rhdf5)
