...
bioconductor package `r Biocpkg("rhdf5")`. 
...
`bit64conversion='bit64'` is recommended way of coercing. It
...
for(file in c('myhdf5file.h5', 'newfile.h5', 'newfile3.h5', 'newfile3.h5')) {
    if(file.exists(file)) {
        file.remove( file )
    }
}
